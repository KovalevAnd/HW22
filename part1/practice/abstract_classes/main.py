...
class Electroscooter(Transport):
    def start_engine(self):
        print("Мигнул светодиодом, показывая что он готов к движению")
...
class Person:
    def use_transport(self, transport_object):
        return transport_object.start_engine(), transport_object.move(), transport_object.stop(), transport_object.stop_engine()
